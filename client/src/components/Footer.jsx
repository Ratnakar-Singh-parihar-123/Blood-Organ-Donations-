...
const Footer = () => {
  ...
  const emergencyContacts = [
    { label: 'National Emergency', number: '102', description: 'Ambulance', color: 'bg-red-50 border-red-100 text-red-800' },
    { label: 'Blood Bank Helpline', number: '104', description: '24/7 Support', color: 'bg-blue-50 border-blue-100 text-blue-800' },
    { label: 'Medical Emergency', number: '108', description: 'All India', color: 'bg-emerald-50 border-emerald-100 text-emerald-800' },
    { label: 'Women Helpline', number: '1091', description: '24/7 Support', color: 'bg-purple-50 border-purple-100 text-purple-800' }
  ];

  const socialLinks = [
    { icon: Facebook, label: 'Facebook', href: '#', color: 'bg-blue-50 hover:bg-blue-100 text-blue-600' },
    { icon: Instagram, label: 'Instagram', href: '#', color: 'bg-pink-50 hover:bg-pink-100 text-pink-600' },
    { icon: Twitter, label: 'Twitter', href: '#', color: 'bg-sky-50 hover:bg-sky-100 text-sky-600' },
    { icon: Youtube, label: 'YouTube', href: '#', color: 'bg-red-50 hover:bg-red-100 text-red-600' },
    { icon: Linkedin, label: 'LinkedIn', href: '#', color: 'bg-blue-100 hover:bg-blue-200 text-blue-700' }
  ];
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-gray-50 via-white to-gray-50 pt-16 pb-12">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute top-0 right-1/4 w-64 h-64 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute -bottom-32 left-1/2 w-64 h-64 bg-emerald-300 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {certifications.map((cert, index) => (
                <div key={index} className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm hover:shadow transition-all duration-200">
            ...
            <div className="bg-gradient-to-r from-rose-50 to-pink-50 rounded-2xl p-6 border border-rose-100 shadow-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
                <div className="flex items-center space-x-3 mb-4 sm:mb-0">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-500">24/7 EMERGENCY SUPPORT</div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <a href="#" className="text-gray-600 hover:text-rose-600 transition-colors font-medium">
              Terms of Service
            </a>
