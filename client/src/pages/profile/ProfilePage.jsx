      ...
      case "organDonor":
        return [
          ...
          },
          {
            ...
            icon: CheckCircle,
            color: userData.medicalClearance
              ? "text-emerald-500"
              : "text-amber-500",
            bg: userData.medicalClearance ? "bg-emerald-50" : "bg-amber-50",
            border: userData.medicalClearance
              ? "border-emerald-200"
              : "border-amber-200",
          },
        ];
        ...
        return [
          {
            ...
            icon: AlertTriangle,
            color:
              userData.urgencyLevel === "emergency"
                ? "text-red-500"
                : userData.urgencyLevel === "urgent"
                  ? "text-amber-500"
                  : "text-blue-500",
            bg:
              userData.urgencyLevel === "emergency"
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {organs.map((organ) => (
                  <label
                    key={organ}
                    className={`flex items-center gap-3 p-2.5 rounded-lg border ${isEditing ? "cursor-pointer hover:bg-emerald-50" : "cursor-default"} ${(formData.organsToDonate || []).includes(organ) ? "bg-emerald-50 border-emerald-300 text-emerald-700" : "bg-white border-gray-200"}`}
                  >
                    <input
                      type="checkbox"
                      name="organsToDonate"
            ...
            <div className="space-y-4 p-4 bg-emerald-50 rounded-xl border border-emerald-200">
              <label
                className={`flex items-start gap-3 ${isEditing ? "cursor-pointer" : "cursor-default"}`}
              >
                <input
                  type="checkbox"
                  name="familyConsent"
                ...
                />
                <span
                  className={`text-sm ${formData.familyConsent ? "text-emerald-800 font-medium" : "text-gray-700"}`}
                >
                  I have discussed organ donation with my family and have their
                  consent
                </span>
              </label>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {departmentsList.map((dept) => {
                  const isSelected = (formData.departments || []).includes(
                    dept,
                  );
                  return (
                    <button
                      ...
                      <div className="space-y-2">
                        ...
                        {isEditing ? (
                          ...
                          <div className="px-3 py-2.5 bg-gray-50 rounded-lg text-gray-900">
                            {userData.hospitalName || "Not provided"}
                          </div>
                        )}
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500">
                      You joined JeevanDaan community
                    </div>
                  </div>
                  <div className="text-sm text-gray-500">
                    {new Date(
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <Link to="/" className="flex items-center gap-2 group">
                <div
                  className={`bg-gradient-to-r ${userType.gradient} p-2 rounded-lg shadow-sm group-hover:scale-105 transition-transform duration-200`}
                >
              ...
              <div className="hidden md:block ml-4">
                <span
                  className={`px-3 py-1 rounded-full text-sm font-medium ${userType.bgColor} ${userType.textColor} border ${userType.borderColor}`}
                >
                  {userType.label}
                </span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <div className={`relative overflow-hidden rounded-xl shadow-lg mb-4`}>
            <div
              className={`absolute inset-0 bg-gradient-to-r ${userType.gradient} opacity-90`}
            ></div>
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-white rounded-full border-2 border-white flex items-center justify-center">
                      <userType.icon
                        className={`h-4 w-4 ${userType.gradient.replace("from-", "text-").split(" ")[0]}`}
                      />
                    </div>
                  </div>
                  <div>
          ...
          {message.text && (
            <div
              className={`p-3 rounded-lg flex items-center gap-3 animate-fadeIn shadow-sm ${
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
              ...
              <div className="space-y-3">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className={`p-3 rounded-lg border ${stat.border} ${stat.bg} hover:scale-[1.02] transition-transform duration-200`}
                  >
                    <div className="flex items-center gap-2">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <div className={`p-1.5 rounded ${action.bg}`}>
                          <action.icon
                            className={`h-3.5 w-3.5 ${action.color}`}
                          />
                        </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {quickActions.slice(0, 4).map((action, index) => (
                  ...
                  >
                    ...
                    <span className="text-xs font-medium text-gray-700 group-hover:text-gray-900 text-center truncate w-full">
                      {action.label}
                    </span>
                  </button>
                ))}
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg p-4">
        <div className="grid grid-cols-2 gap-3">
          {stats.slice(0, 4).map((stat, index) => (
            <div
              key={index}
              className={`p-2 rounded-lg border ${stat.border} ${stat.bg}`}
            >
              <div className="flex items-center gap-2">
